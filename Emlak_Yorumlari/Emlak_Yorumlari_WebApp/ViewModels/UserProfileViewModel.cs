...
namespace Emlak_Yorumlari_WebApp.ViewModels
{
    public class UserProfileViewModel
    {
        ...
        [DisplayName("Şifre"), DataType(DataType.Password), StringLength(12, ErrorMessage = "{0} max {1} karater olmalı!")]
        public string password { get; set; }

        [DisplayName("Şifre Tekrar"), DataType(DataType.Password), StringLength(12, ErrorMessage = "{0} max {1} karater olmalı!"),
