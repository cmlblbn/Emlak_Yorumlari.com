...
namespace Emlak_Yorumlari.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Emlak_Yorumlari_Entities.MyContext>
    {
        ...
        protected override void Seed(Emlak_Yorumlari_Entities.MyContext context)
        {
            ...
            //         workbook = application.Workbooks.Open(@"C:\Users\Cemal\Desktop\Emlak_Yorumlari.com\örnek excel");
            ...
            //     }
            //context.Question_Definitions.AddOrUpdate(new Question_Definition()
            //{
            //    question_id = 1,
            //    question_name = "Güven Puanı",
            //    IsActive = true
            //});
            //context.Question_Definitions.AddOrUpdate(new Question_Definition()
            //{
            //    question_id = 2,
            //    question_name = "Aktivite Alanı",
            //    IsActive = true
            //});
            //context.Question_Definitions.AddOrUpdate(new Question_Definition()
            //{
            //    question_id = 3,
            //    question_name = "Yönetim Memnuniyeti",
            //    IsActive = true
            //});
